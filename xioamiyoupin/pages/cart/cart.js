Page({
  data: {
    ...
    carts: [
      {
        id: 1,
        pic: "https://img.alicdn.com/bao/uploaded/i4/2495029969/TB2sPCGu2iSBuNkSnhJXXbDcpXa_!!2495029969.png",
        name: "日本资生堂洗颜",
        price: 200,
        isSelect: false,
        // 数据设定
      ...
      {
        id: 2,
        pic: 'https://img.alicdn.com/bao/uploaded/i3/1653734047/TB2d0O9pVXXXXbJXXXXXXXXXXXX_!!1653734047.jpg',
        name: "倩碧焕妍活力精华露",
        price: 340,
        isSelect: false,
        // 数据设定
  ...
  onLoad: function (options) {
    ...
    // const arr = wx.getStorageSync('carts');
    // console.log('这是cart1'+arr)
    // console.log('this.data'+ this.data)
    // let carts = this.data.carts;
    // carts = [...arr];
    //  var num = wx.getStorageSync('carts');//wx.getStorageSync(key)，获取本地缓存
    // if (arr.length > 0) {
    //   // 更新数据  
    //   this.setData({
    //     carts: arr,
